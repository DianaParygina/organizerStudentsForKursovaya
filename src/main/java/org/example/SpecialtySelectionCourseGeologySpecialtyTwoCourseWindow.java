...
public class SpecialtySelectionCourseGeologySpecialtyTwoCourseWindow extends JFrame {

    private final JTable specialtyGeologyTable;
    private final DefaultTableModel specialtyGeologyTableModel;

    public SpecialtySelectionCourseGeologySpecialtyTwoCourseWindow(String title) {
